...
class PaymentController {
    ...
    {
        View::render('/var/www/html/dev/workspace/web/notes-v3/mvc/view/payment/cart.php');
    }

    public function request()
    {
        require_once('/var/www/html/dev/workspace/web/notes-v3/lib/nusoap/nusoap.php');
        ...
        $mobile = '09054244609';
        $callbackURL = 'http://localhost/dev/workspace/web/notes-v3/payment/verify';
