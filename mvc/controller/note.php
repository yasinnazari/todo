...
class NoteController {
    ...
    public function submit()
    {
        if (isset($_POST['title'])){
            ...
            View::render("/var/www/html/dev/workspace/web/todo/mvc/view/note/submit.php");
        }
    }
    ...
    private function submitNote()
    {
        ...
        if (!isset($_SESSION['user_id'])){
            header("Location: /dev/workspace/web/todo/page/home");
            exit;
        }
    ...
    public function catalog($pageIndex)
    {
        ...
        View::render("/var/www/html/dev/workspace/web/todo/mvc/view/page/catalog.php", $data);
    }
    ...
    public function ajaxCatalog($pageIndex)
    {
        ...
        ob_start();
            View::render("/var/www/html/dev/workspace/web/todo/mvc/view/page/ajaxCatalog.php", $data);
        $output = ob_get_clean();
