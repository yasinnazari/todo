<div id="header-top-right">
    ...
    <? } else { ?>
        ...
        <a href="/dev/workspace/web/notes-v3/user/login" style="margin-right: 15px;" class="btn"><?=_btn_exit?></a>
    <? } ?>
</div>
...
<div id="notes">
    ...
    <? } else { ?>
        ...
        <?= pageination('/dev/workspace/web/notes-v3/note/catalog', 2, 'pageination-btn', $pageIndex);  ?>
        <br>
        <br>
        <hr>
        <br>
        ...
        <br><br>
        <div class="tal">
            <a class="btn-blue tal" href="/dev/workspace/web/notes-v3/note/catalog/1"><?=_all_notes?></a>
...
<script>
    function getPage(pageIndex){
        $.ajax('/dev/workspace/web/notes-v3/note/ajaxCatalog/' + pageIndex, {
            type: 'post',
            dataType: 'json',
