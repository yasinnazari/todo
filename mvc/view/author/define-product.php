<br>
<form method="post" action="/dev/workspace/web/shop/author/defineProduct" enctype="multipart/form-data"><br><br>
    ...
    <br>
    <br>
    <input type="file" name="image" placeholder="تصویر محصول" accept=".png, .jpg" style="padding: 10px;">
    <br><br>
